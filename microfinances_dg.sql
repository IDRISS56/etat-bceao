...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 12 juin 2026 à 16:17
...
--
-- Base de données : `microfinances_dg`
--
...
('AGC-001', 'AG01', 'Siège Social', 'Abidjan, Plateau', NULL, NULL, NULL, NULL, NULL, '2026-06-09 14:48:19', 'active'),
...
('CAI002', 'CAI002', 'Caisse Guichet Yopougon', 'CT002', 50000000.00, 25000000.00, 'AGC002', 'ouverte'),
('CAI003', 'CAI003', 'Caisse Bouaké', 'CT002', 300000000.00, 20000000.00, 'AGC003', 'ouverte');
...
('CLI-001', 'MT001', 'KOUASSI', 'Jean', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Personne physique', NULL, NULL, NULL, NULL, 0, NULL, NULL, 0.00, NULL, 'Rural', NULL, NULL, 'A01', 'AGC-001', 'NUI-CI-0012345', 'PP', NULL, '2026-06-09 14:48:19', 'actif'),
('CLI-002', 'MT002', 'DIALLO', 'Aminata', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Personne physique', NULL, NULL, NULL, NULL, 0, NULL, NULL, 0.00, NULL, 'Rural', NULL, NULL, 'A01', 'AGC-001', 'NUI-CI-0067890', 'PP', NULL, '2026-06-09 14:48:19', 'actif'),
('CLI-003', 'MT003', 'SOCAGRO', 'SA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'Entreprise', NULL, NULL, NULL, NULL, 0, NULL, NULL, 0.00, NULL, 'Rural', NULL, NULL, 'A01', 'AGC-001', 'NUI-CI-0099999', 'SA', NULL, '2026-06-09 14:48:19', 'actif'),
...
('CPT-001', '220001', 'CLI-001', 'Compte Épargne Jean', NULL, NULL, 1500000.00, 0.00, 'F.CFA', '2026-06-09 14:48:19', NULL, NULL, 'actif'),
('CPT-002', '220002', 'CLI-002', 'Compte Épargne Aminata', NULL, NULL, 500000.00, 0.00, 'F.CFA', '2026-06-09 14:48:19', NULL, NULL, 'actif'),
...
('DOS-001', 'CPT-001', NULL, 5000000.000000, 'mois', 12, NULL, '2024-01-15', NULL, '2024-02-15', '2025-01-15', 'Fonds de roulement', 0, '2026-06-09 14:48:19', 'AGC-001', NULL, 'actif'),
('DOS-002', 'CPT-002', NULL, 2000000.000000, 'mois', 6, NULL, '2024-06-01', NULL, '2024-07-01', '2024-12-01', 'Équipement', 0, '2026-06-09 14:48:19', 'AGC-001', NULL, 'impaye'),
...
('ECH-001', 'DOS-001', 1, NULL, '2024-02-15', 450000.000000, 'payee'),
('ECH-002', 'DOS-002', 1, NULL, '2024-07-01', 350000.000000, 'impayee'),
('ECH-003', 'DOS-002', 2, NULL, '2024-08-01', 350000.000000, 'impayee'),
...
('ECR-001', 'JNL-001', NULL, '2024-01-15', 'Octroi crédit DOS-001', 5000000.00, 0.00, '411', NULL, 'TRX-001', NULL, 'USR-01', 'validé'),
('ECR-002', 'JNL-001', NULL, '2024-01-15', 'Octroi crédit DOS-001 (contrepartie)', 0.00, 5000000.00, '22', NULL, 'TRX-001', NULL, 'USR-01', 'validé'),
('ECR-003', 'JNL-002', NULL, '2024-06-01', 'Octroi crédit DOS-002', 2000000.00, 0.00, '412', NULL, 'TRX-002', NULL, 'USR-01', 'validé'),
('ECR-004', 'JNL-002', NULL, '2024-06-01', 'Octroi crédit DOS-002 (contrepartie)', 0.00, 2000000.00, '22', NULL, 'TRX-002', NULL, 'USR-01', 'validé'),
('ECR-005', 'JNL-003', NULL, '2024-10-31', 'Dotation provision DOS-002', 200000.00, 0.00, '68', NULL, 'TRX-003', NULL, 'USR-01', 'validé'),
('ECR-006', 'JNL-003', NULL, '2024-10-31', 'Dotation provision DOS-002 (contrepartie)', 0.00, 200000.00, '49', NULL, 'TRX-003', NULL, 'USR-01', 'validé'),
...
('10', 'Capital social', 'PASSIF', '1', 'DETAIL', NULL, 'CREDIT', 'ACTIF'),
('22', 'Comptes d épargne à régime spécial', 'PASSIF', '2', 'DETAIL', NULL, 'CREDIT', 'ACTIF'),
('41', 'Crédits à la clientèle', 'ACTIF', '4', 'DETAIL', NULL, 'DEBIT', 'ACTIF'),
('411', 'Crédits à court terme', 'ACTIF', '4', 'DETAIL', NULL, 'DEBIT', 'ACTIF'),
('412', 'Crédits à moyen terme', 'ACTIF', '4', 'DETAIL', NULL, 'DEBIT', 'ACTIF'),
('49', 'Provisions pour dépréciation des crédits', 'PASSIF', '4', 'DETAIL', NULL, 'CREDIT', 'ACTIF'),
('68', 'Dotations aux provisions', 'CHARGE', '6', 'DETAIL', NULL, 'DEBIT', 'ACTIF'),
('70', 'Intérêts et produits assimilés sur crédits', 'PRODUIT', '7', 'DETAIL', NULL, 'CREDIT', 'ACTIF');
