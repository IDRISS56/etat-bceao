...
// Z52 (provisions supplémentaires exigées) – saisie manuelle possible
...
<script>
    ...
    function appliquerFiltres() {
        let url = 'R03.php?exercice=' + document.getElementById('exerciceSelect').value + '&type_periode=' + document.getElementById('typePeriodeSelect').value;
        ...
        // Conserver la valeur manuelle de Z52
