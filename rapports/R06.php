...
$Z55 = isset($_POST['Z55']) ? (float)$_POST['Z55'] : 0;
        ...
        <form method="post" id="filterForm">
            ...
            <div style="margin-top:12px; padding:8px; background:#fefce8; border-radius:12px;">
                <div style="display:flex; flex-wrap:wrap; gap:12px; align-items:flex-end;">
                    <div class="filter-item">
                        <label>Z55 - Activités hors épargne/crédit</label>
                        <input type="number" name="Z55" value="<?=$Z55?>" step="1000" style="width:200px;">
                    </div>
                    <div style="font-size:0.7rem; color:#6b7280; margin-bottom:8px;">Saisir le montant total des opérations autres que l’épargne et le crédit (ex: commerce, immobilier, etc.)</div>
                </div>
            </div>
        </form>
    </div>
