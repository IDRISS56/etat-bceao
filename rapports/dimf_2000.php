...
// FPDF intégré, gestion des filtres par POST, PDF en POST, Bootstrap
...
"); $stmt->execute(); $A3A_brut = $stmt->fetch()['total']; } catch (PDOException $e) {}
...
"); $stmt->execute(); $A3B_brut = $stmt->fetch()['total']; } catch (PDOException $e) {}
...
"); $stmt->execute(); $A70_brut = $stmt->fetch()['total']; } catch (PDOException $e) {}
...
"); $stmt->execute(); $B30_brut = $stmt->fetch()['total']; } catch (PDOException $e) {}
...
"); $stmt->execute(); $B40_brut = $stmt->fetch()['total']; } catch (PDOException $e) {}
...
"); $stmt->execute(); $G2A_net = $stmt->fetch()['total']; } catch (PDOException $e) {}
...
"); $stmt->execute([':date_fin' => $date_fin_periode]); $L01_net = $stmt->fetch()['total']; } catch (PDOException $e) {}
