...
<div class="dashboard">
    ...
    <div class="card">
        ...
        <div class="info-box">
            ...
            <div><?=($conformite=='CONFORME')?'✓ Conforme – L\'exposition sur le plus gros client représente '.number_format($pourcentage,2).'% des fonds propres, ≤10%.':'⚠️ Non conforme – L\'exposition sur le plus gros client dépasse 10% des fonds propres.'?></div>
        </div>
    </div>
