...
// Exports PDF et Excel structurés
...
$valeurs_realisables = $disponibilites + $a12 + $a3a; // a3a utilisé ici comme b2d simplifié
...
function appliquerFiltres() {
    let url = 'Ratio_resume.php?exercice=' + document.getElementById('exerciceSelect').value + '&type_periode=' + document.getElementById('typePeriodeSelect').value;
